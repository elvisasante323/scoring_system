...
try {
    $stmt = $connection->prepare("UPDATE tournament.score_board SET third_event_scores = ? WHERE id = ?");
    ...
    echo json_encode([
        'error' => 'Scores for event 3 were not saved!'
    ]);
}
...
echo json_encode([
    'success' => 'Scores for event 3 has been saved'
]);
