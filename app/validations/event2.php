...
try {
    $stmt = $connection->prepare("UPDATE tournament.score_board SET second_event_scores = ? WHERE id = ?");
    ...
    echo json_encode([
        'error' => 'Scores for event 2 were not saved!'
    ]);
}
...
echo json_encode([
    'success' => 'Scores for event 2 has been saved'
]);
